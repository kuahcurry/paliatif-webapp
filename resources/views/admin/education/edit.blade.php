    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <div class="card" style="max-width: 720px;">
                ...
                <form method="POST" action="{{ route('admin.education.update', $module) }}" class="form-body">
                    @csrf @method('PUT')
                    ...
                    <div class="field">
                        ...
                        <div class="checkbox-grid">
                            ...
                            @foreach ($tagOptions as $value => $label)
                                <label><input type="checkbox" name="tags[]" value="{{ $value }}" @checked(in_array($value, old('tags', $module->tags ?? [])))> {{ $label }}</label>
                            @endforeach
                        </div>
                    ...
                    <div class="field">
                        <label><input type="checkbox" name="is_active" value="1" @checked(old('is_active', $module->is_active))> Aktif</label>
                    </div>

                    <div class="field">
                        <label><input type="checkbox" name="is_highlighted" value="1" @checked(old('is_highlighted', $module->is_highlighted))> Tambahkan ke aktivitas yang disarankan</label>
